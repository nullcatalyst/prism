...
uint32_t gpu_create_buffer(uint32_t ctx_obj, uint32_t usage, size_t full_size, size_t offset,
                           const void* ptr, size_t size);
WASM_IMPORT(gpu, updateBuffer)
uint32_t gpu_update_buffer(uint32_t ctx_obj, uint32_t buffer_obj, size_t offset, const void* ptr,
                           size_t size);
